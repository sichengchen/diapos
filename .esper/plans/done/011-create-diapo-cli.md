...
## Progress
- Created CLI script at packages/create-diapos/src/index.ts (copies template, replaces package name, prints next steps)
- Created full template: index.html, package.json, vite.config.ts, tsconfig.json, src/main.tsx, src/slides.tsx, src/theme.ts
- Template imports from 'diapos' and 'diapos/styles.css'
- CLI tested: scaffolds correct directory with right package name
- Modified: packages/create-diapos/package.json, packages/create-diapos/src/index.ts, packages/create-diapos/template/*
- Verification: CLI scaffolding works, all tests pass, typecheck clean
